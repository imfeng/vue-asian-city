  ...
  head: {
    ...
    meta: [
      ...
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      {
        ...
        name: 'description',
        content:
          '最新消息，本司于2009年经营第三分摇彩平台至今，一贯秉持公正，公开，创新三大理念！是崭新且公正的第三方摇彩平台！'
      },
      { hid: 'keywords', name: 'keywords', content: '南韩娱乐网,最新消息' }
    ]
  },
  data() {
    return {
